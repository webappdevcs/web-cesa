...
use Cesa\Kepegawaian\Database\Factories\EmployeeFactory;
...
class Employee extends Model
{
    ...
    {
        return __('kepegawaian::models/employee.title');
    }

    protected function mobilePhone(): Attribute
    {
        return Attribute::make(
            set: fn (?string $value): ?string => $this->normalizePhoneNumber($value),
        );
    }
    ...
    protected static function boot()
    {
        ...
        static::updating(function (self $employee): void {
            if ($employee->isDirty('uuid') && $employee->getOriginal('uuid') !== null) {
                throw new LogicException('The canonical employee UUID is immutable.');
            }
        });
