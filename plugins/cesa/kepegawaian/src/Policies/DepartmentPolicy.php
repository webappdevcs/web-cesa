...
class DepartmentPolicy
{
    ...
    {
        return $user->can('view_any_kepegawaian_department');
    }
    ...
    {
        return $user->can('create_kepegawaian_department');
    }
    ...
    {
        return $user->can('delete_any_kepegawaian_department');
    }
    ...
    {
        return $user->can('force_delete_any_kepegawaian_department');
    }
    ...
    {
        return $user->can('restore_any_kepegawaian_department');
    }
}
