...
class CalendarPolicy
{
    ...
    {
        return $user->can('view_any_kepegawaian_calendar');
    }
    ...
    {
        return $user->can('create_kepegawaian_calendar');
    }
    ...
    {
        return $user->can('delete_any_kepegawaian_calendar');
    }
    ...
    {
        return $user->can('force_delete_any_kepegawaian_calendar');
    }
    ...
    {
        return $user->can('restore_any_kepegawaian_calendar');
    }
}
