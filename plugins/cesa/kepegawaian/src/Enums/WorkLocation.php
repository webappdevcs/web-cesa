...
enum WorkLocation: string implements HasColor, HasIcon, HasLabel
{
    ...
    {
        return match ($this) {
            self::Home   => __('kepegawaian::enums/work-location.home'),
            self::Office => __('kepegawaian::enums/work-location.office'),
            self::Other  => __('kepegawaian::enums/work-location.other'),
        };
    }
