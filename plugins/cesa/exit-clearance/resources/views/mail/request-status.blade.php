          ...
          <table cellpadding="0" cellspacing="0" width="100%" style="background:#fff; border-radius:6px; overflow:hidden;">
            <tr>
              <td style="background:#B32324; color:#fff; text-align:center; padding:18px 24px;">
                <h1 style="margin:0; font-size:20px; color:#fff;">Status Exit Clearance</h1>
              </td>
            </tr>
            <tr>
              <td style="padding:24px;">
                <p style="margin-top:0;">
                  Status pengajuan Anda saat ini: <strong>{{ $statusLabel }}</strong>
                </p>
                ...
                <p>
                  <small>
                    Lihat progres lengkap di sini:
                    <a href="{{ $progressUrl }}" target="_blank">cek status pengajuan</a>.
                  </small>
                </p>
              </td>
            </tr>
